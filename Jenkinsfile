        ...
        stage('Deploy to Github') {
            ...
            steps {
                ...
                script {
                    ...
                    sh "curl -XPOST -H \"Accept: application/vnd.github+json\" -H \"Authorization: Bearer ${GITHUB_CREDS_PSW}\" https://api.github.com/repos/catly1/OledBlinds/releases -d '${API_create}' > RELEASE"
