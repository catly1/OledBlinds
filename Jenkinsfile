        ...
        stage('Deploy to Github') {
            ...
            steps {
                ...
                script {
                    ...
                    sh "curl -X POST -H \"Accept: application/vnd.github+json\" -H \"Authorization: Bearer ${GITHUB_CREDS_PSW}\" https://api.github.com/repos/catly1/OledBlinds/releases -d '${API_create}'> RELEASE"
                    ...
                    if(info != null) {
                        ...
                        sh "curl -X POST -H \"Authorization:token ${GITHUB_CREDS_PSW}\" -H \"Content-Type:application/octet-stream\"  --data-binary @${location} https://uploads.github.com/repos/catly1/OledBlinds/releases/${release_id}/assets?name=app-release.apk"
                    } else {
