...
class IntentGuideFragment: com.catly.oledblinds.view.guide.BaseGuideFragment(R.layout.intent_guide_fragment, R.id.action_intentGuideFragment_to_guideIndexFragment) {
